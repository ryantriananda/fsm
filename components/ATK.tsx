...
const initialInventory: ATKItem[] = [
  { id: '1', name: 'A4 Paper (80gsm)', stock: 45, unit: 'Rim', category: 'Paper', minStock: 10 },
  { id: '2', name: 'Ballpoint Pen (Black)', stock: 120, unit: 'Pcs', category: 'Writing', minStock: 50 },
  { id: '3', name: 'Ballpoint Pen (Blue)', stock: 85, unit: 'Pcs', category: 'Writing', minStock: 50 },
  { id: '4', name: 'Stapler No. 10', stock: 15, unit: 'Pcs', category: 'Desk Accessories', minStock: 5 },
  { id: '5', name: 'Staples Refill No. 10', stock: 50, unit: 'Box', category: 'Desk Accessories', minStock: 20 },
  { id: '6', name: 'Post-it Notes (Yellow)', stock: 30, unit: 'Pad', category: 'Paper', minStock: 10 },
  { id: '7', name: 'Bantex Folder (Blue)', stock: 8, unit: 'Pcs', category: 'Filing', minStock: 15 }, // Low stock example
];
...
const ATK: React.FC = () => {
  ...
  const handleApprove = (reqId: string) => {
    ...
    for (const item of request.items) {
      ...
      if (stockItemIndex === -1 || newInventory[stockItemIndex].stock < item.quantity) {
        canApprove = false;
        break;
      }
      newInventory[stockItemIndex].stock -= item.quantity;
    }
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredInventory.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">{item.stock}</td>
